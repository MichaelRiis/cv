...
\item[] \textit{Assistant Professor}%
            ...
            \begin{innerlist}
                \item Machine learning, statistics, and signal processing
            \end{innerlist}
...
\item \textit{Gabriel R. Mayol, main supervisor: Virgilio G. Rubio, Valencia polytech.}%
            \hfill \textbf{2020}


\item \textit{Akash Dhaka, main supervisor: Aki Vehtari, Aalto University}%
            \hfill \textbf{2020}

\item \textit{Maxim Khomiako, main supervisor: Jes Frellsen, DTU}%
            \hfill \textbf{2023}
...
\textbf{Peer-reviewing} IEEE Signal processing letters, Journal of Statistics and Computing, International Conference of Machine Learning,  International Conference for Neural Information Processing Systems, Stan Conference, International Conference on Artificial Intelligence and Statistics
% \halfblankline
% \vspace{0.1in}
...
Citation statistics: 379 citations and h-index: 6 (Google Scholar)\\[0.25cm]


\begin{bibenum}

\item A. K. Dhaka, A. Catalina, \textbf{M. R. Andersen}, M. Magnusson, J. Huggins, A. Vehtari. Robust, Accurate Stochastic Optimization for Variational Inference, \textit{Accepted for publication in proceedings of Advances in Neural Information Processing Systems 2020}
