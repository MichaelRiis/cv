...
Machine learning, probabilistic and statistical modelling, Bayesian statistics, variational inference, sparse recovery, inverse problems, signal processing, image processing, neuroimaging, \& applied mathematics.
...
\item[] \textit{Visiting student researcher}%
            ...
            \begin{innerlist}
                \item Worked on a project called "Model-based dynamic functional connectivity"
...
\item[] \textit{Assistant teacher}%
    ...
    \item[] \textit{Student programmer}%
            ...
            \begin{innerlist}
                \item Real-time EEG preprocessing and artifact removal using
